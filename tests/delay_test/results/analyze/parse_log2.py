...
def remove_zeros(data):
    filtered_data = [value for value in data if value != 0.0]
...
# 示例使用
input_log_path = '../qos_tests/normal/top_cpu_100.log'
output_log_path = '../qos_tests/docker_stats_01_filtered.log'
process_log_file(input_log_path, output_log_path)
